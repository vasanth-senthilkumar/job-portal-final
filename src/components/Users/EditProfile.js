...
class EditProfile extends Component {
    ...
    onSubmit = e => {
        ...
        if (isValid) {
            axios
                .put('https://salty-ridge-97263.herokuapp.com/user/edit_profile/' + user.id, editedUser)
                .then(response => {
            ...
            this.state.jobs.filter(item => item.recruiter === user.id).forEach((jobb) => 
            {
                ...
                axios
                    .put('https://salty-ridge-97263.herokuapp.com/job/edit_job/' + jobb._id, editJob)
                    .then(response => {
                        console.log(editJob);
                    })
                    .catch(function(error) {
    ...
    render() {
        ...
        if(userRole === 'applicant') {
            EditUserDetails = 
            <form noValidate onSubmit={this.onSubmit} style={{ background: `#2980B9`,
