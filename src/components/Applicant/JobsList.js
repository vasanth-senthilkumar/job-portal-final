...
class JobsList extends Component {
    ...
    onSOPsubmit(job)
    {
        ...
        {
            axios
                .post('https://salty-ridge-97263.herokuapp.com/application/add_application', newApplication)
                .then(response => {
            ...
            axios
                .put('https://salty-ridge-97263.herokuapp.com/user/edit_profile/' + user.id, editApplicant)
                .then(response => {
